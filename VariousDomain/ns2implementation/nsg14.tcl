...
set tracefd       [open mac_802_11_node_40_ftp_38_cbr_39_ping_1624.tr w]	;#??trace file
set namtrace       [open mac_802_11_node_40_ftp_38_cbr_39_ping_1624.nam w]	;#????nam trace file
...
$ns attach-agent $node_(22) $tcp20
$ns attach-agent $node_(23) $sink20
...
$ns attach-agent $node_(23) $tcp21
$ns attach-agent $node_(24) $sink21
...
$ns attach-agent $node_(36) $tcp33
$ns attach-agent $node_(37) $sink33
...
$ns attach-agent $node_(20) $tcp37
$ns attach-agent $node_(22) $sink37
...
$ns attach-agent $node_(0) $udp38
set null38 [new Agent/Null]
$ns attach-agent $node_(1) $null38
...
$ns attach-agent $node_(1) $udp39
set null39 [new Agent/Null]
$ns attach-agent $node_(2) $null39
...
$ns attach-agent $node_(2) $udp40
set null40 [new Agent/Null]
$ns attach-agent $node_(3) $null40
...
$ns attach-agent $node_(3) $udp41
set null41 [new Agent/Null]
$ns attach-agent $node_(4) $null41
...
$ns attach-agent $node_(4) $udp42
set null42 [new Agent/Null]
$ns attach-agent $node_(5) $null42
...
$ns attach-agent $node_(5) $udp43
set null43 [new Agent/Null]
$ns attach-agent $node_(6) $null43
...
$ns attach-agent $node_(6) $udp44
set null44 [new Agent/Null]
$ns attach-agent $node_(7) $null44
...
$ns attach-agent $node_(7) $udp45
set null45 [new Agent/Null]
$ns attach-agent $node_(8) $null45
...
$ns attach-agent $node_(9) $null46
...
$ns attach-agent $node_(9) $udp47
set null47 [new Agent/Null]
$ns attach-agent $node_(10) $null47
...
$ns attach-agent $node_(10) $udp48
set null48 [new Agent/Null]
$ns attach-agent $node_(11) $null48
...
$ns attach-agent $node_(11) $udp49
...
$ns attach-agent $node_(12) $udp50
set null50 [new Agent/Null]
$ns attach-agent $node_(13) $null50
...
$ns attach-agent $node_(13) $udp51
set null51 [new Agent/Null]
$ns attach-agent $node_(14) $null51
...
$ns attach-agent $node_(14) $udp52
set null52 [new Agent/Null]
$ns attach-agent $node_(15) $null52
...
$ns attach-agent $node_(15) $udp53
set null53 [new Agent/Null]
$ns attach-agent $node_(16) $null53
...
$ns attach-agent $node_(16) $udp54
set null54 [new Agent/Null]
$ns attach-agent $node_(17) $null54
...
$ns attach-agent $node_(17) $udp55
set null55 [new Agent/Null]
$ns attach-agent $node_(18) $null55
...
$ns attach-agent $node_(18) $udp56
set null56 [new Agent/Null]
$ns attach-agent $node_(19) $null56
...
$ns attach-agent $node_(19) $udp57
set null57 [new Agent/Null]
$ns attach-agent $node_(20) $null57
...
$ns attach-agent $node_(20) $udp58
set null58 [new Agent/Null]
$ns attach-agent $node_(22) $null58
...
$ns attach-agent $node_(22) $udp59
set null59 [new Agent/Null]
$ns attach-agent $node_(23) $null59
...
$ns attach-agent $node_(23) $udp60
set null60 [new Agent/Null]
$ns attach-agent $node_(24) $null60
...
$ns attach-agent $node_(24) $udp61
set null61 [new Agent/Null]
$ns attach-agent $node_(25) $null61
...
$ns attach-agent $node_(25) $udp62
set null62 [new Agent/Null]
$ns attach-agent $node_(26) $null62
...
$ns attach-agent $node_(26) $udp63
set null63 [new Agent/Null]
$ns attach-agent $node_(27) $null63
...
$ns attach-agent $node_(27) $udp64
set null64 [new Agent/Null]
$ns attach-agent $node_(28) $null64
...
$ns attach-agent $node_(28) $udp65
set null65 [new Agent/Null]
$ns attach-agent $node_(29) $null65
...
$ns attach-agent $node_(29) $udp66
set null66 [new Agent/Null]
$ns attach-agent $node_(30) $null66
...
$ns attach-agent $node_(30) $udp67
set null67 [new Agent/Null]
$ns attach-agent $node_(31) $null67
...
$ns attach-agent $node_(31) $udp68
set null68 [new Agent/Null]
$ns attach-agent $node_(32) $null68
...
$ns attach-agent $node_(32) $udp69
set null69 [new Agent/Null]
$ns attach-agent $node_(33) $null69
...
$ns attach-agent $node_(33) $udp70
set null70 [new Agent/Null]
$ns attach-agent $node_(34) $null70
...
$ns attach-agent $node_(34) $udp71
set null71 [new Agent/Null]
$ns attach-agent $node_(35) $null71
...
$ns attach-agent $node_(35) $udp72
set null72 [new Agent/Null]
$ns attach-agent $node_(36) $null72
...
$ns attach-agent $node_(36) $udp73
set null73 [new Agent/Null]
$ns attach-agent $node_(37) $null73
...
$ns attach-agent $node_(37) $udp74
set null74 [new Agent/Null]
$ns attach-agent $node_(38) $null74
...
$ns attach-agent $node_(38) $udp75
set null75 [new Agent/Null]
$ns attach-agent $node_(39) $null75
...
$ns attach-agent $node_(39) $udp76
set null76 [new Agent/Null]
$ns attach-agent $node_(40) $null76
