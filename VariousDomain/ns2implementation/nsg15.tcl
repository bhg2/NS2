...
set tracefd       [open mac_802_11_node_41_ftp_40_cbr_42_ping_43.tr w]	;#??trace file
set namtrace       [open mac_802_11_node_41_ftp_40_cbr_42_ping_43.nam w]	;#????nam trace file
...
$ns attach-agent $node_(12) $sink11
...
$ns attach-agent $node_(14) $sink13
...
$ns attach-agent $node_(15) $tcp15
$ns attach-agent $node_(16) $sink15
...
$ns attach-agent $node_(17) $tcp17
$ns attach-agent $node_(18) $sink17
...
$ns attach-agent $node_(18) $tcp18
...
$ns attach-agent $node_(19) $tcp19
$ns attach-agent $node_(20) $sink19
...
$ns attach-agent $node_(20) $tcp20
$ns attach-agent $node_(21) $sink20
...
$ns attach-agent $node_(21) $tcp21
$ns attach-agent $node_(22) $sink21
...
$ns attach-agent $node_(22) $tcp22
$ns attach-agent $node_(23) $sink22
...
$ns attach-agent $node_(23) $tcp23
$ns attach-agent $node_(24) $sink23
...
$ns attach-agent $node_(24) $tcp24
$ns attach-agent $node_(25) $sink24
...
$ns attach-agent $node_(25) $tcp25
$ns attach-agent $node_(26) $sink25
...
$ns attach-agent $node_(26) $tcp26
$ns attach-agent $node_(27) $sink26
...
$ns attach-agent $node_(27) $tcp27
$ns attach-agent $node_(28) $sink27
...
$ns attach-agent $node_(29) $tcp28
...
$ns attach-agent $node_(29) $tcp29
$ns attach-agent $node_(30) $sink29
...
$ns attach-agent $node_(30) $tcp30
$ns attach-agent $node_(31) $sink30
...
$ns attach-agent $node_(31) $tcp31
$ns attach-agent $node_(32) $sink31
...
$ns attach-agent $node_(32) $tcp32
$ns attach-agent $node_(33) $sink32
...
$ns attach-agent $node_(33) $tcp33
$ns attach-agent $node_(34) $sink33
...
$ns attach-agent $node_(34) $tcp34
$ns attach-agent $node_(35) $sink34
...
$ns attach-agent $node_(35) $tcp35
$ns attach-agent $node_(36) $sink35
...
$ns attach-agent $node_(36) $tcp36
$ns attach-agent $node_(37) $sink36
...
$ns attach-agent $node_(37) $tcp37
$ns attach-agent $node_(38) $sink37
...
$ns attach-agent $node_(38) $tcp38
$ns attach-agent $node_(39) $sink38
...
$ns attach-agent $node_(39) $tcp39
$ns attach-agent $node_(40) $sink39
...
$ns attach-agent $node_(0) $null40
...
$ns attach-agent $node_(0) $udp41
set null41 [new Agent/Null]
$ns attach-agent $node_(1) $null41
...
$ns attach-agent $node_(1) $udp42
set null42 [new Agent/Null]
$ns attach-agent $node_(2) $null42
...
$ns attach-agent $node_(2) $udp43
set null43 [new Agent/Null]
$ns attach-agent $node_(3) $null43
...
$ns attach-agent $node_(3) $udp44
set null44 [new Agent/Null]
$ns attach-agent $node_(4) $null44
...
$ns attach-agent $node_(4) $udp45
set null45 [new Agent/Null]
$ns attach-agent $node_(5) $null45
...
$ns attach-agent $node_(5) $udp46
set null46 [new Agent/Null]
$ns attach-agent $node_(6) $null46
...
$ns attach-agent $node_(6) $udp47
set null47 [new Agent/Null]
$ns attach-agent $node_(7) $null47
...
$ns attach-agent $node_(7) $udp48
set null48 [new Agent/Null]
$ns attach-agent $node_(8) $null48
...
$ns attach-agent $node_(8) $udp49
set null49 [new Agent/Null]
$ns attach-agent $node_(9) $null49
...
$ns attach-agent $node_(10) $null50
...
$ns attach-agent $node_(10) $udp51
set null51 [new Agent/Null]
$ns attach-agent $node_(11) $null51
...
$ns attach-agent $node_(11) $udp52
set null52 [new Agent/Null]
$ns attach-agent $node_(12) $null52
...
$ns attach-agent $node_(12) $udp53
set null53 [new Agent/Null]
$ns attach-agent $node_(13) $null53
...
$ns attach-agent $node_(13) $udp54
set null54 [new Agent/Null]
$ns attach-agent $node_(14) $null54
...
$ns attach-agent $node_(14) $udp55
set null55 [new Agent/Null]
$ns attach-agent $node_(15) $null55
...
$ns attach-agent $node_(15) $udp56
set null56 [new Agent/Null]
$ns attach-agent $node_(16) $null56
...
$ns attach-agent $node_(16) $udp57
set null57 [new Agent/Null]
$ns attach-agent $node_(17) $null57
...
$ns attach-agent $node_(17) $udp58
set null58 [new Agent/Null]
$ns attach-agent $node_(18) $null58
...
$ns attach-agent $node_(18) $udp59
set null59 [new Agent/Null]
$ns attach-agent $node_(19) $null59
...
$ns attach-agent $node_(19) $udp60
set null60 [new Agent/Null]
$ns attach-agent $node_(20) $null60
...
$ns attach-agent $node_(20) $udp61
set null61 [new Agent/Null]
$ns attach-agent $node_(21) $null61
...
$ns attach-agent $node_(21) $udp62
set null62 [new Agent/Null]
$ns attach-agent $node_(22) $null62
...
$ns attach-agent $node_(22) $udp63
set null63 [new Agent/Null]
$ns attach-agent $node_(23) $null63
...
$ns attach-agent $node_(23) $udp64
set null64 [new Agent/Null]
$ns attach-agent $node_(24) $null64
...
$ns attach-agent $node_(24) $udp65
set null65 [new Agent/Null]
$ns attach-agent $node_(25) $null65
...
$ns attach-agent $node_(25) $udp66
set null66 [new Agent/Null]
$ns attach-agent $node_(26) $null66
...
$ns attach-agent $node_(26) $udp67
set null67 [new Agent/Null]
$ns attach-agent $node_(27) $null67
...
$ns attach-agent $node_(27) $udp68
set null68 [new Agent/Null]
$ns attach-agent $node_(28) $null68
...
$ns attach-agent $node_(28) $udp69
set null69 [new Agent/Null]
$ns attach-agent $node_(29) $null69
...
$ns attach-agent $node_(29) $udp70
set null70 [new Agent/Null]
$ns attach-agent $node_(30) $null70
...
$ns attach-agent $node_(30) $udp71
set null71 [new Agent/Null]
$ns attach-agent $node_(31) $null71
...
$ns attach-agent $node_(31) $udp72
set null72 [new Agent/Null]
$ns attach-agent $node_(32) $null72
...
$ns attach-agent $node_(32) $udp73
set null73 [new Agent/Null]
$ns attach-agent $node_(33) $null73
...
$ns attach-agent $node_(33) $udp74
set null74 [new Agent/Null]
$ns attach-agent $node_(34) $null74
$ns connect $udp74 $null74
$udp74 set fid_ 2	;#?NAM??UDP?????????
set cbr74 [new Application/Traffic/CBR]	;#?UDP??????CBR????
$cbr74 attach-agent $udp74
$cbr74 set type_ CBR
$cbr74 set packet_size_ 1000;#??????
$cbr74 set rate_ 512Kb ;#??????
$cbr74 set random_ false
$ns at 1.0 "$cbr74 start"
$ns at 2.0 "$cbr74 stop"

#???75???(CBR-UDP)
set udp75 [new Agent/UDP]
$ns attach-agent $node_(34) $udp75
set null75 [new Agent/Null]
$ns attach-agent $node_(35) $null75
$ns connect $udp75 $null75
$udp75 set fid_ 2	;#?NAM??UDP?????????
set cbr75 [new Application/Traffic/CBR]	;#?UDP??????CBR????
$cbr75 attach-agent $udp75
$cbr75 set type_ CBR
$cbr75 set packet_size_ 1000;#??????
$cbr75 set rate_ 512Kb ;#??????
$cbr75 set random_ false
$ns at 1.0 "$cbr75 start"
$ns at 2.0 "$cbr75 stop"

#???76???(CBR-UDP)
set udp76 [new Agent/UDP]
$ns attach-agent $node_(35) $udp76
set null76 [new Agent/Null]
$ns attach-agent $node_(36) $null76
...
$ns attach-agent $node_(36) $udp77
set null77 [new Agent/Null]
$ns attach-agent $node_(37) $null77
$ns connect $udp77 $null77
$udp77 set fid_ 2	;#?NAM??UDP?????????
set cbr77 [new Application/Traffic/CBR]	;#?UDP??????CBR????
$cbr77 attach-agent $udp77
$cbr77 set type_ CBR
$cbr77 set packet_size_ 1000;#??????
$cbr77 set rate_ 512Kb ;#??????
$cbr77 set random_ false
$ns at 1.0 "$cbr77 start"
$ns at 2.0 "$cbr77 stop"

#???78???(CBR-UDP)
set udp78 [new Agent/UDP]
$ns attach-agent $node_(37) $udp78
set null78 [new Agent/Null]
$ns attach-agent $node_(38) $null78
$ns connect $udp78 $null78
$udp78 set fid_ 2	;#?NAM??UDP?????????
set cbr78 [new Application/Traffic/CBR]	;#?UDP??????CBR????
$cbr78 attach-agent $udp78
$cbr78 set type_ CBR
$cbr78 set packet_size_ 1000;#??????
$cbr78 set rate_ 512Kb ;#??????
$cbr78 set random_ false
$ns at 1.0 "$cbr78 start"
$ns at 2.0 "$cbr78 stop"

#???79???(CBR-UDP)
set udp79 [new Agent/UDP]
$ns attach-agent $node_(38) $udp79
set null79 [new Agent/Null]
$ns attach-agent $node_(39) $null79
...
$ns attach-agent $node_(19) $ping_a(101)
...
$ns attach-agent $node_(20) $ping_a(102)
...
$ns attach-agent $node_(21) $ping_a(103)
...
$ns attach-agent $node_(22) $ping_a(104)
...
$ns attach-agent $node_(23) $ping_a(105)
...
$ns attach-agent $node_(24) $ping_a(106)
...
$ns attach-agent $node_(25) $ping_a(107)
...
$ns attach-agent $node_(26) $ping_a(108)
